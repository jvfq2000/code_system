...
<main role="main" class="container-fluid">
    ...
    <div class="container">
        <h1 class="display-3" style="font-size: 50pt">
            <img class="rounded-circle" src="<?php echo base_url('assets/img/icone/atividade.png'); ?>" alt="Generic placeholder image" width="100" height="100">
    ...
    <div id="view">
        <?php 
            if ($mostrar == "tabela") {
                $this->load->view('include/atividade_aluno/tabela');
            }
            if ($mostrar == "operacoes") {
                $this->load->view('include/atividade_aluno/operacoes');
            }
        ?>
    </div>
</main>
