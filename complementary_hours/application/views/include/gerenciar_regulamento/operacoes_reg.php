    ...
    <div class="accordion" id="accordionExample">
        <div class="shadow card-header rounded mx-auto col-sm-7" id="headingOne">
            <form name="formuser" class="form-group needs-validation"
                ...
                <div class="card-header rounded col-sm-12" id="headingOne">                    
                    <div class="row">
                        <a class="shadow-sm mx-auto col-12 btn btn-outline-primary text-left"  href="" role="button" data-toggle="modal" data-target="#modal_escolher_regulamento">
                            <?php if($pegou_regulamento == "S"){?>
                                Alterar Regulamento  
                            <?php }else{?>
                                Selecionar Regulamento  
                            <?php }?>
                            <img src="<?php echo base_url('assets/img/icone/documento.png');?>" class="float-right" width="35" height="30"/>
                        </a>
                    </div>
                <!--</form>-->
                </div>
...
<br>
    <body class="bg-white">
        <div class="modal fade" name="modal_escolher_regulamento" id="modal_escolher_regulamento" tabindex="-1" role="dialog">
        ...
        <div class="modal fade" name="modal_confirmar_cadastro" id="modal_confirmar_cadastro" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <?php if ($sucesso){ ?>
                                    <button type="button" class="btn btn-primary" data-dismiss="modal">Ok</button>
                                    <a class="btn btn-primary"  href="<?php echo base_url('Regulamento/novo');?>" role="button">Cadastrar Novo</a>
