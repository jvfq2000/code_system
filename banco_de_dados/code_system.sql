...
-- Copiando estrutura do banco de dados para code_system
DROP DATABASE IF EXISTS `code_system`;
CREATE DATABASE IF NOT EXISTS `code_system` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `code_system`;

-- Copiando estrutura para tabela code_system.aluno
...
-- Copiando dados para a tabela code_system.aluno: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `aluno` DISABLE KEYS */;
/*!40000 ALTER TABLE `aluno` ENABLE KEYS */;

-- Copiando estrutura para tabela code_system.aluno_ati
DROP TABLE IF EXISTS `aluno_ati`;
CREATE TABLE IF NOT EXISTS `aluno_ati` (
  ...
  `aluno_ati_comprovado` varchar(5) NOT NULL,
  `aluno_ati_justificativa` varchar(300) DEFAULT NULL,
  `aluno_ati_semestre` tinyint(4) NOT NULL,
  `aluno_ati_ano` int(4) NOT NULL,
...
-- Copiando dados para a tabela code_system.aluno_ati: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `aluno_ati` DISABLE KEYS */;
INSERT INTO `aluno_ati` (`aluno_ati_id`, `usuario_id`, `campus_id`, `curso_id`, `atividade_id`, `aluno_ati_descricao`, `aluno_ati_doc`, `aluno_ati_qtd_horas`, `aluno_ati_comprovado`, `aluno_ati_justificativa`, `aluno_ati_semestre`, `aluno_ati_ano`, `aluno_ati_qtd_horas_aprovadas`, `aluno_ati_visto`) VALUES
	(1, 1, 1, 3, 1, 'Palestra qualquer', '5fa9cd1ac25f8.png', 10.00, 'Sim', NULL, 1, 2018, NULL, NULL),
	(2, 1, 1, 3, 17, 'Bolinho do Jão', '5fa9cf55c3fb5.pdf', 5.00, 'Sim', NULL, 2, 2018, NULL, NULL),
	(3, 1, 1, 3, 2, 'Teste atividade 6', '5fa9dd89e911a.png', 19.00, 'Sim', NULL, 2, 2019, NULL, NULL);
/*!40000 ALTER TABLE `aluno_ati` ENABLE KEYS */;

-- Copiando estrutura para tabela code_system.atividade
...
-- Copiando dados para a tabela code_system.atividade: ~41 rows (aproximadamente)
/*!40000 ALTER TABLE `atividade` DISABLE KEYS */;
INSERT INTO `atividade` (`atividade_id`, `quadro_id`, `atividade_cat_id`, `atividade_descricao`, `atividade_horas_min`, `atividade_horas_max`) VALUES
	(1, 2, 3, 'XV.Participação em Empresa Júnior', 20.00, 20.00),
	(2, 2, 3, 'XIV.Participação em visitas técnicas voltadas para o curso.', 10.00, 20.00),
	(3, 2, 3, 'XIII.Desenvolvimento de software e homepages institucionais', 10.00, 10.00),
	(4, 2, 3, 'XII.3.11Participação como conselheiro em câmaras e conselhos da IFNMG, membro da direção ou coordena', 10.00, 10.00),
	(5, 2, 3, 'XI.Participação em palestras pertinentes à área de formação', 3.00, 15.00),
	(6, 2, 3, 'X.Participação em cursos de curta duração, mini- cursos ou oficinas de atualização pertinentes à áre', 10.00, 40.00),
	(7, 2, 3, 'IX.Apresentação de palestras em seminários, semanas, simpósios, congressos, colóquios e encontros re', 10.00, 10.00),
	(8, 2, 3, 'VIII.Participação da comissão organizadora de seminários, semanas, simpósios, congressos e encontros', 10.00, 10.00),
	(9, 2, 3, 'VII.Realização de relacionados à área de formação,. estágios extracurriculares', 20.00, 40.00),
	(10, 2, 3, 'VI.Autoria/co-autoria de resumidos em regionais e nacionais da área de Sistemas de Informação e afin', 5.00, 5.00),
	(11, 2, 3, 'V.Autoria/co-autoria de completos em regionais e nacionais da área de Sistemas de Informação e afins', 5.00, 15.00),
	(12, 2, 3, 'IV.Autoria/co-autoria de trabalhos completos em periódicos internacionais da área de Sistemas de Inf', 10.00, 20.00),
	(13, 2, 3, 'III.Autoria/co-autoria de trabalhos resumidos em anais de encontros de extensão e/ou científicos', 5.00, 10.00),
	(14, 2, 3, 'II.Autoria/co-autoria de trabalhos completos em anais de encontros de extensão e/ou científicos', 5.00, 10.00),
	(15, 2, 3, 'I.Participação em programas/projetos institucionalizados de extensão, devidamente cadastrados e orie', 5.00, 45.00),
	(16, 2, 2, 'IX.Participação em seminários, simpósios, congressos, e encontros regionais, nacionais e internacion', 10.00, 40.00),
	(17, 2, 2, 'VIII.Realização de estágios extracurriculares relacionados à área de formação', 10.00, 10.00),
	(18, 2, 2, 'VII.Apresentação de palestras em seminários, simpósios, congressos e encontros regionais, nacionais ', 5.00, 5.00),
	(19, 2, 2, 'VI.Autoria/co-autoria de trabalhos resumidos em periódicos regionais e nacionais da área de Sistemas', 20.00, 20.00),
	(20, 2, 2, 'V.Autoria/co-autoria de completos em regionais e nacionais da área de Sistemas de Informação e afins', 15.00, 15.00),
	(21, 2, 2, 'IV.Autoria/co-autoria de trabalhos completos em periódicos internacionais da área de Sistemas de Inf', 20.00, 20.00),
	(22, 2, 2, 'III.Autoria/co-autoria de trabalhos resumidos em anais de encontros científicos', 5.00, 5.00),
	(23, 2, 2, 'II.Autoria/co-autoria de trabalhos completos em anais de encontros científicos', 10.00, 10.00),
	(24, 2, 2, 'I.Participação em projetos registrados e orientados por professores de IES, pelo período mínimo de u', 15.00, 30.00),
	(25, 2, 1, 'XIII.Autoria/co-autoria de trabalhos resumidos em periódicos da área de Sistemas de Informação e afi', 10.00, 10.00),
	(26, 2, 1, 'XII.Autoria/co-autoria de trabalhos completos em periódicos regionais e nacionais da área de Sistema', 15.00, 15.00),
	(27, 2, 1, 'XI.Autoria/co-autoria de trabalhos completos em periódicos internacionais da área de Sistemas de Inf', 20.00, 20.00),
	(28, 2, 1, 'X.Autoria/co-autoria de trabalhos resumidos em anais de encontros científicos', 10.00, 20.00),
	(29, 2, 1, 'IX.Autoria/co-autoria de trabalhos completos em anais de encontros científicos', 10.00, 20.00),
	(30, 2, 1, 'VIII.Participação em monitorias em disciplinas do curso de graduação do IFNMG –Campus Arinos (volunt', 10.00, 10.00),
	(31, 2, 1, 'VII.Participação em palestras pertinentes à área de formação', 3.00, 15.00),
	(32, 2, 1, 'VI.Apresentação de palestras em seminários, simpósios, congressos e encontros regionais, nacionais e', 15.00, 15.00),
	(33, 2, 1, 'V.Estágios extracurriculares relacionados à área de formação.', 30.00, 60.00),
	(34, 2, 1, 'IV.Cursos de curta duração, mini-cursos ou oficinas de atualização pertinentes à área de formação, p', 10.00, 60.00),
	(35, 2, 1, 'III.Atuação como monitor em eventos.', 5.00, 10.00),
	(36, 2, 1, 'II.Participação em semanas, simpósios, congressos, colóquios e encontros regionais, nacionais e inte', 10.00, 20.00),
	(37, 2, 1, 'I.Participação em projetos (educativos, artísticos e culturais) de intervenção social de curta duraç', 2.00, 10.00),
	(38, 3, 2, 'Teste atividade 3', 25.00, 50.00),
	(39, 3, 3, 'Teste atividade 2', 25.00, 50.00),
	(40, 3, 1, 'Teste atividade 1', 50.00, 100.00),
	(41, 4, 3, 'teste 4', 10.00, 10.00),
	(42, 4, 3, 'teste 3', 10.00, 10.00),
	(43, 4, 3, 'teste 2', 10.00, 10.00),
	(44, 4, 3, 'teste 1', 10.00, 10.00);
/*!40000 ALTER TABLE `atividade` ENABLE KEYS */;

-- Copiando estrutura para tabela code_system.atividade_cat
DROP TABLE IF EXISTS `atividade_cat`;
CREATE TABLE IF NOT EXISTS `atividade_cat` (
...
-- Copiando dados para a tabela code_system.atividade_cat: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `atividade_cat` DISABLE KEYS */;
INSERT INTO `atividade_cat` (`atividade_cat_id`, `campus_id`, `atividade_cat_descricao`, `atividade_cat_horas_max`) VALUES
	(1, 1, 'Atividades de Ensino (máximo 100 horas)', 100.00),
	(2, 1, 'Atividades de Pesquisa (Máximo 50 horas)', 50.00),
	(3, 1, 'Atividades de Extensão (máximo 50 horas)', 50.00);
/*!40000 ALTER TABLE `atividade_cat` ENABLE KEYS */;

-- Copiando estrutura para tabela code_system.campus
...
CREATE TABLE IF NOT EXISTS `campus` (
  ...
  KEY `FK_campus_estado` (`estado_id`),
  KEY `FK_campus_cidade` (`cidade_id`),
  CONSTRAINT `FK_campus_cidade` FOREIGN KEY (`cidade_id`) REFERENCES `cidade` (`cidade_id`),
  CONSTRAINT `FK_campus_estado` FOREIGN KEY (`estado_id`) REFERENCES `estado` (`estado_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela code_system.campus: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `campus` DISABLE KEYS */;
INSERT INTO `campus` (`campus_id`, `estado_id`, `cidade_id`, `campus_descricao`) VALUES
	(1, 11, 2514, 'IFNMG - Campus Arinos'),
	(2, 11, 2496, 'IFNMG - Campus Araçuai'),
	(3, 11, 2457, 'IFNMG - Campus Almenara');
/*!40000 ALTER TABLE `campus` ENABLE KEYS */;

-- Copiando estrutura para tabela code_system.cidade
...
-- Copiando dados para a tabela code_system.cidade: ~9.586 rows (aproximadamente)
/*!40000 ALTER TABLE `cidade` DISABLE KEYS */;
INSERT INTO `cidade` (`cidade_id`, `cidade_nome`, `estado_id`) VALUES
	(3, 'Brasiléia', 1),
	(4, 'Bujari', 1),
	(5, 'Capixaba', 1),
	(6, 'Cruzeiro do Sul', 1),
...
-- Copiando estrutura para tabela code_system.curso
...
-- Copiando dados para a tabela code_system.curso: ~6 rows (aproximadamente)
...
-- Copiando estrutura para tabela code_system.estado
DROP TABLE IF EXISTS `estado`;
CREATE TABLE IF NOT EXISTS `estado` (
  `estado_id` int(11) NOT NULL,
  `estado_nome` varchar(45) NOT NULL,
  `estado_sigla` varchar(2) NOT NULL,
  PRIMARY KEY (`estado_id`,`estado_sigla`),
  UNIQUE KEY `sigla_UNIQUE` (`estado_sigla`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Copiando dados para a tabela code_system.estado: ~27 rows (aproximadamente)
...
-- Copiando estrutura para tabela code_system.pessoa
...
-- Copiando dados para a tabela code_system.pessoa: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `pessoa` DISABLE KEYS */;
INSERT INTO `pessoa` (`pessoa_id`, `usuario_id`, `campus_id`, `curso_id`, `pessoa_nome`, `pessoa_sobrenome`, `pessoa_data_nascimento`, `pessoa_telefone`, `pessoa_foto_perfil`) VALUES
	(1, 1, 1, 3, 'Aluno', 'Teste', '1111-11-11', '(11) 11111-1111', 'logo.jpeg'),
	(2, 2, 1, 3, 'Usuario 2', 'teste', '0000-00-00', '(22) 22222-2222', 'logo.jpeg'),
	(3, 3, 1, 3, 'Usuario 3', 'teste', '0000-00-00', '(33) 33333-3333', 'logo.jpeg'),
	(4, 4, 1, 3, 'Usuario 4', 'testel', '0000-00-00', '(44) 44444-4444', '5f7a772aa554f.jpg');
/*!40000 ALTER TABLE `pessoa` ENABLE KEYS */;

-- Copiando estrutura para tabela code_system.professor
...
-- Copiando dados para a tabela code_system.professor: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `professor` DISABLE KEYS */;
/*!40000 ALTER TABLE `professor` ENABLE KEYS */;

-- Copiando estrutura para tabela code_system.quadro
DROP TABLE IF EXISTS `quadro`;
CREATE TABLE IF NOT EXISTS `quadro` (
  `quadro_id` int(11) NOT NULL AUTO_INCREMENT,
  `campus_id` int(11) DEFAULT NULL,
  `curso_id` int(11) DEFAULT NULL,
  `quadro_descricao` varchar(100) DEFAULT NULL,
  `quadro_horas_max` decimal(5,2) DEFAULT NULL,
  PRIMARY KEY (`quadro_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela code_system.quadro: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `quadro` DISABLE KEYS */;
INSERT INTO `quadro` (`quadro_id`, `campus_id`, `curso_id`, `quadro_descricao`, `quadro_horas_max`) VALUES
	(2, 1, 3, 'Curso de Sistemas de Informação do IFNMG – Campus Arinos (2017)', 200.00),
	(3, 1, 3, 'Quadro somente teste', 200.00),
	(4, 1, 3, 'teste', 50.00);
/*!40000 ALTER TABLE `quadro` ENABLE KEYS */;

-- Copiando estrutura para tabela code_system.regulamento
...
-- Copiando dados para a tabela code_system.regulamento: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `regulamento` DISABLE KEYS */;
INSERT INTO `regulamento` (`regulamento_id`, `campus_id`, `curso_id`, `regulamento_descricao`, `regulamento_caminho`, `regulamento_ano`) VALUES
	(1, 1, 3, 'ANEXO II – REGULAMENTO DAS ATIVIDADES COMPLEMENTARES', '5fa9b81c0cc93.pdf', 2017),
	(2, 1, 3, 'ANEXO III – REGULAMENTO DAS ATIVIDADES COMPLEMENTARES', '5fa9b872b792b.pdf', 2018),
	(3, 1, 3, 'ANEXO IV – REGULAMENTO DAS ATIVIDADES COMPLEMENTARES', '5fa9b8b1d6a18.pdf', 2020),
	(4, 1, 3, 'Teste regulamento', '5fa9e05e61899.pdf', 2019);
/*!40000 ALTER TABLE `regulamento` ENABLE KEYS */;

-- Copiando estrutura para tabela code_system.usuario
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `usuario_validou_email` char(1) NOT NULL DEFAULT 'N' COMMENT 'S: Sim ou N: Não',
  PRIMARY KEY (`usuario_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela code_system.usuario: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
INSERT INTO `usuario` (`usuario_id`, `usuario_email`, `usuario_senha`, `usuario_nivel`, `usuario_validou_email`) VALUES
	(1, 'usuario1@aluno.ifnmg.edu.br', '$2y$10$C3jSminJ.xJvlKkUowQbY.WJISIJozQxPwbGd88StsCQccM6zD/Vq', 1, 'S'),
	(2, 'usuario2@ifnmg.edu.br', '$2y$10$tKBS78C0qHLA7Jdeh4H7gOvT6HvmAz0bPnVaAqkim.ceBxKVW39ee', 2, 'S'),
	(3, 'usuario3@ifnmg.edu.br', '$2y$10$Q3mln8HXBPmwVtAROWAUUuCV.OxfGxyQZNp4p//tgTyEkLkd4Arva', 3, 'S'),
	(4, 'usuario4@ifnmg.edu.br', '$2y$10$Iq3OfNHYCvYsVPAKYJQww.5JhBruzB3fyqKxWMrImS3.Ws7MWAX4G', 4, 'S');
