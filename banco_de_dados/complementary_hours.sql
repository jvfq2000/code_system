...
CREATE TABLE IF NOT EXISTS `aluno` (
  ...
  `aluno_ano_inicio_curso` smallint(6) NOT NULL DEFAULT '0',
  `aluno_semestre_inicio_curso` tinyint(4) NOT NULL DEFAULT '0' COMMENT '1: 1° ou 2: 2°',
...
CREATE TABLE IF NOT EXISTS `curso` (
  ...
  KEY `FK_curso_campus` (`campus_id`),
  CONSTRAINT `FK_curso_campus` FOREIGN KEY (`campus_id`) REFERENCES `campus` (`campus_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela complementary_hours.curso: ~5 rows (aproximadamente)
DELETE FROM `curso`;
/*!40000 ALTER TABLE `curso` DISABLE KEYS */;
INSERT INTO `curso` (`curso_id`, `campus_id`, `curso_descricao`, `curso_qtd_periodos`) VALUES
	(1, 1, 'Bacharelado em Administração', 8),
	(2, 1, 'Bacharelado em Agronomia', 10),
	(3, 1, 'Bacharelado em Sistemas de Informação', 8),
	(4, 1, 'Tecnologia em Gestão Ambiental', 6),
	(5, 1, 'Tecnologia em Produção de Grãos', 6);
...
CREATE TABLE IF NOT EXISTS `pessoa` (
  ...
  `pessoa_foto_perfil` varchar(100) DEFAULT NULL,
...
-- Copiando dados para a tabela complementary_hours.pessoa: ~4 rows (aproximadamente)
DELETE FROM `pessoa`;
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `usuario_validou_email` char(1) NOT NULL DEFAULT 'F' COMMENT 'S: Sim ou N: Não',
  PRIMARY KEY (`usuario_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela complementary_hours.usuario: ~4 rows (aproximadamente)
DELETE FROM `usuario`;
/*!40000 ALTER TABLE `usuario` DISABLE KEYS */;
INSERT INTO `usuario` (`usuario_id`, `usuario_email`, `usuario_senha`, `usuario_nivel`, `usuario_validou_email`) VALUES
	(6, 'usuario1@email.com', 'usuario1', 1, 'F'),
	(7, 'usuario2@email.com', 'usuario2', 2, 'F'),
	(8, 'usuario3@email.com', 'usuario3', 3, 'F'),
	(9, 'joaovictorfariass@gmail.com', '123456', 1, 'F');
