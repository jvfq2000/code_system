              ...
              <form class="form-group" novalidate>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="telefone" placeholder="" value="" pattern="\([0-9]{2}\)[0-9]{4,6}-[0-9]{3,4}$" required>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-6 mb-5">
                    <a class="col-12 btn btn-danger btn-lg" href="<?php echo base_url('login')?>" role="button">Cancelar</a>
                  </div>  
                </div>
              </form>
          </div>
